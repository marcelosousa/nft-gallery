<template>
  <div>
    <h1>Cookie Policy for KodaDot</h1>

    <p>
      This is the Cookie Policy for KodaDot, accessible from
      https://nft.kodadot.xyz
    </p>
    ...
    <ul>
      <li>By visiting this link: https://nft.kodadot.xyz</li>
    </ul>
  </div>
</template>
